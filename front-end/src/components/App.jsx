...
function RenderizarListarGentilezas(props) {
  return (
    <section>
      ...
      />
      <FixedButton index="3" type="primary" url="/gentileza" />
      <FixedButton index="7" type="secondary" onClick={props.recarregar} />
      <ButtonImage tipo="header-menu" url="/perfil" />
    </section>
  );
}
function RenderizarNovaGentileza(props) {
  return <NovaGentileza key={props.id} {...props} />;
}
